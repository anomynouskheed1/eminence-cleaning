...
export default function TestimonialCarousel() {
    ...
    return (
        <div className="bg-white border border-eminence-gray-200 p-8 h-full flex flex-col justify-between">
            <div>
                <span className="text-4xl text-eminence-green/30 font-heading block mb-4">“</span>
                ...
                {testimonials.length > 1 && (
                    <div className="flex gap-2">
                        <button
                            ...
                            className="w-8 h-8 flex items-center justify-center border border-eminence-gray-200 hover:border-eminence-green transition-colors"
                        >
                            ←
                        </button>
                        <button
